module.exports = {
  generateRoutesV6Demo: function generateRoutesV6Demo(router) {
    ...
    const lessonList = [
      {
        ...
        url: '/v6-demo/topic/lesson/lesson-objective',
        videos: [
          {
            id: '1',
            description:
            ...
            backLink: '/v6-demo/topic/lesson/1/select-learning-content',
            nextLink: '/v6-demo/topic/lesson/1/video/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v6-demo/topic/lesson/1/video/practice/1',
            nextLink: '/v6-demo/topic/lesson/1/video/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v6-demo/topic/lesson/1/video/practice/2',
            nextLink: '/v6-demo/topic/lesson/1/video/practice/3'
          }
        ],
        slideshows: [
          {
            ...
            backLink: '/v6-demo/topic/lesson/1/select-learning-content',
            nextLink: '/v6-demo/topic/lesson/1/slideshow/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v6-demo/topic/lesson/1/slideshow/practice/1',
            nextLink: '/v6-demo/topic/lesson/1/slideshow/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v6-demo/topic/lesson/1/slideshow/practice/2',
            nextLink: '/v6-demo/topic/lesson/1/slideshow/practice/3'
          }
        ],
        practiceVideoQuestions: [
          {
            ...
            backLink: '/v6-demo/topic/lesson/1/video/1',
            nextLink: '/v6-demo/topic/lesson/1/video/2',
          ...
          },
          {
            ...
            backLink: '/v6-demo/topic/lesson/1/video/2',
            nextLink: '/v6-demo/topic/lesson/1/video/3',
          ...
          },
          {
            ...
            backLink: '/v6-demo/topic/lesson/1/video/3',
            nextLink: '/v6-demo/topic/lesson/1/start-quiz',
        ...
        practiceSlideshowQuestions: [
          {
            ...
            backLink: '/v6-demo/topic/lesson/1/slideshow/1',
            nextLink: '/v6-demo/topic/lesson/1/slideshow/2',
            nextLinkText: 'Continue to part 2'
          },
          {
            id: '2',
            ...
            backLink: '/v6-demo/topic/lesson/1/slideshow/2',
            nextLink: '/v6-demo/topic/lesson/1/slideshow/3',
            nextLinkText: 'Continue to part 3'
          },
          {
            id: '3',
            ...
            backLink: '/v6-demo/topic/lesson/1/slideshow/3',
            nextLink: '/v6-demo/topic/lesson/1/start-quiz',
            nextLinkText: 'Continue to quiz'
          }
        ],
        practiceTextQuestions: [
          {
            ...
            backLink: '/v6-demo/topic/lesson/1/text/1',
            nextLink: '/v6-demo/topic/lesson/1/text/2',
            nextLinkText: 'Continue to part 2'
          },
          {
            id: '2',
            ...
            backLink: '/v6-demo/topic/lesson/1/text/2',
            nextLink: '/v6-demo/topic/lesson/1/text/3',
            nextLinkText: 'Continue to part 3'
          },
          {
            id: '3',
            ...
            backLink: '/v6-demo/topic/lesson/1/text/3',
            nextLink: '/v6-demo/topic/lesson/1/start-quiz',
            nextLinkText: 'Continue to quiz'
          }
        ],
        assessmentQuestions: [
          {
            ...
            backLink: '#',
            nextLink: '/v6-demo/topic/lesson/1/assessment/2',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v6-demo/topic/lesson/1/assessment/3',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v6-demo/topic/lesson/1/assessment/4',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v6-demo/topic/lesson/1/assessment/5',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v6-demo/topic/lesson/1/feedback',
          ...
          links: [
            {
              ...
              href: '/v6-demo/prototype-limit/' + encodeURIComponent(path)
            },
            {
              text: 'Speak to a tutor (via email)',
              href: '/v6-demo/speak-to-tutor/' + encodeURIComponent(path)
            },
            {
              text: 'Technical support',
              href: '/v6-demo/technical-support/' + encodeURIComponent(path)
            }
          ]
        },
        {
          ...
          links: [
            {
              ...
              href: '/v6-demo/topic/lesson/1/start-quiz'
            }
          ]
        }
      ]
    ...
    router.get('/v6-demo', function(req, res) {
      res.render('main/v6-demo/start', {
        heading: {
          main: 'This is a prototype'
        },
        nextLink: '/v6-demo/prototype-context'
      })
    })

    router.get('/v6-demo/prototype-context', function(req, res) {
      res.render('main/v6-demo/prototype-context', {
        heading: {
          main: 'This is a prototype'
        },
        nextLink: '/v6-demo/context'
      })
    })

    router.get('/v6-demo/end', function(req, res) {
      res.render('main/v6-demo/end', {
        heading: {
    ...
    router.get('/v6-demo/context', function(req, res) {
      res.render('main/v6-demo/context-page', {
        heading: {
          main: 'English Functional Skills Level 2'
        },
        nextLink: '/v6-demo/topic/select-lesson'
      })
    })

    router.get('/v6-demo/start-part-two', function(req, res) {
      res.render('main/v6-demo/start-part-two', {
        heading: {
          main: "You've completed the course"
        },
        description: 'You did 60 lessons over a few months.',
        nextLink: '/v6-demo/course/completed'
      })
    })

    router.get('/v6-demo/prototype-limit/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v6-demo/prototype-limit', {
        heading: {
    ...
    router.get('/v6-demo/speak-to-tutor/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v6-demo/speak-to-tutor', {
        heading: {
    ...
    router.get('/v6-demo/technical-support/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v6-demo/technical-support', {
        heading: {
          main:
    ...
    router.get('/v6-demo/course/completed', function(req, res) {
      res.render('main/v6-demo/course/completed', {
        heading: {
          sub: COURSE_NAME,
          main: 'Congratulations, you have completed the course!'
        },
        deadLink: '/v6-demo/prototype-limit/' + encodeURIComponent(req.path)
      })
    })

    router.get('/v6-demo/course/actions', function(req, res) {
      res.render('main/v6-demo/course/actions', {
        back: {
          text: 'Return to course',
          href: `/v6-demo/course/completed`
        },
        heading: {
            ...
            links: [
              {
                ...
                href: '/v6-demo/course/find-a-centre'
              },
              {
                text: 'Getting a qualification',
                href: '/v6-demo/prototype-limit/' + encodeURIComponent(req.path)
              },
              {
                html:
    ...
    router.get('/v6-demo/course/find-a-centre', function(req, res) {
      res.render('main/v6-demo/course/find-a-centre', {
        back: {
          text: 'Back',
          href: `/v6-demo/course/actions`
        },
        heading: {
        ...
        // description:
        //   'You have completed a course. Now you can look for a test centre to sit an exam. Alternatively, if you don’t feel quite ready, you can continue learning by going back through the course or by downloading a practice paper.',
        lessonUrl: '/v6-demo/topic/lesson/1/lesson-objective',
        side: [
          {
            title: 'Need help?',
            description:
    ...
    router.get('/v6-demo/course/search-results', function(req, res) {
      res.render('main/v6-demo/course/search-results', {
        back: {
          text: 'Back',
          href: `main/v6-demo/course/find-a-centre`
        },
        heading: {
          main: 'Search results'
        },
    ...
    router.get('/v6-demo/topic/select-lesson', function(req, res) {
      res.render('main/v6-demo/topic/select-lesson', {
        heading: COURSE_NAME,
    ...
    router.get('/v6-demo/topic/lesson/:lessonId/lesson-objective', function(
      req,
      res
    ) {
      ...
      if (!lesson) {
        res.redirect('/v6-demo/topic/select-lesson')
      }
      res.render('main/v6-demo/topic/lesson/lesson-objective', {
        back: {
          text: 'Back',
          href: '/v6-demo/topic/select-lesson'
        },
        lesson
      })
    })
    ...
    router.get(
      '/v6-demo/topic/lesson/:lessonId/select-learning-content',
      function(req, res) {
        const lessonId = req.params.lessonId
        const lesson = lessonList.find(x => x.id === lessonId)
        if (!lesson) {
        ...
        res.render('main/v6-demo/topic/lesson/select-learning-content', {
          back: {
            text: 'Back',
            href: `/v6-demo/topic/lesson/${lessonId}/lesson-objective`
          },
          lesson,
    ...
    router.get('/v6-demo/topic/lesson/:lessonId/video/:videoId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v6-demo/templates/video', {
        back: {
          text: 'Back',
          href: video.backLink
        },
        ...
        actions: {
          ...
          links: [
            ...
            },
            {
              ...
              // href: `/v6-demo/topic/lesson/${lessonId}/select-learning-content`
              html: `<span class="govuk-body-m"><a class="small-link" href="/v6-demo/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, article or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get(
      '/v6-demo/topic/lesson/:lessonId/slideshow/:slideshowId',
      function(req, res) {
        const lessonId = req.params.lessonId
        const lesson = lessonList.find(x => x.id === lessonId)
        if (!lesson) {
        ...
        res.render('main/v6-demo/templates/slides', {
          back: {
            text: 'Back',
            href: slideshow.backLink
              ? slideshow.backLink
              : '/v6-demo/prototype-limit/' + encodeURIComponent(req.path)
          },
          heading: lesson.title,
          slideshow,
          ...
          actions: {
            ...
            links: [
              ...
              },
              {
                ...
                // href: `/v6-demo/topic/lesson/${lessonId}/select-learning-content`
                html: `<span class="govuk-body-m"><a class="small-link" href="/v6-demo/topic/lesson/${lessonId}/select-learning-content">Change to video, article or audio</a></p>`
              }
            ]
          },
          side: helpLinks(req.path)
    ...
    router.get(
      '/v6-demo/topic/lesson/:lessonId/:media/practice/:questionId',
      function(req, res) {
        ...
        const template =
          question.type === 'input'
            ? 'main/v6-demo/templates/question-input'
            : 'main/v6-demo/templates/question'
    ...
    router.get('/v6-demo/topic/lesson/:lessonId/learning-content', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      if (learningContent === 'slideshow') {
        ...
        res.redirect(
          `/v6-demo/topic/lesson/${lessonId}/slideshow/${slideshow.id}`
        )
      } else if (learningContent === 'text') {
        res.redirect(`/v6-demo/topic/lesson/${lessonId}/text/1`)
        ...
        res.redirect(`/v6-demo/topic/lesson/${lessonId}/video/${video.id}`)
      } else {
        res.redirect(
          `/v6-demo/topic/lesson/${lessonId}/select-learning-content`
        )
    ...
    router.get('/v6-demo/topic/lesson/:lessonId/start-quiz', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v6-demo/topic/lesson/start-quiz', {
        back: {
          text: 'Back to lesson',
          href: `/v6-demo/topic/lesson/${lessonId}/select-learning-content`
        },
        ...
        side: [
          {
            ...
            links: [
              ...
              {
                text: 'Speak to a tutor (via email)',
                href: '/v6-demo/speak-to-tutor/' + encodeURIComponent(req.path)
              }
            ]
          }
        ]
    ...
    router.get(
      '/v6-demo/topic/lesson/:lessonId/assessment/:questionId',
      function(req, res) {
        const lessonId = req.params.lessonId
        const lesson = lessonList.find(x => x.id === lessonId)
        if (!lesson) {
        ...
        const questionId = req.params.questionId
        const question = lesson.assessmentQuestions.find(
          x => x.id === questionId
        )
        if (!question) {
          res.redirect(
        ...
        //   ...q,
        //   backLink: '/v6-demo/prototype-limit/' + encodeURIComponent(req.path)
        // }))
        ...
        res.render(template, {
          // back: {
          //   text: 'Back to lesson',
          //   href: '/v6-demo/prototype-limit/' + encodeURIComponent(req.path) // videoContent.backLink
          // },
          heading: {
            sub: lesson.title,
          ...
          side: [
            {
              ...
              links: [
                ...
                },
                {
                  text: 'Speak to a tutor (via email)',
                  href:
                    '/v6-demo/speak-to-tutor/' + encodeURIComponent(req.path)
                }
                // {
                //   text: 'Skip this question',
                //   onClick: 'return v4SkipQuestion();',
    ...
    router.get('/v6-demo/topic/lesson/:lessonId/feedback', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6-demo/topic/select-lesson')
      ...
      res.render('main/v6-demo/topic/lesson/feedback', {
        // back: {
        //   text: 'Exit lesson',
        //   href: '/v6-demo/prototype-limit/' + encodeURIComponent(req.path)
        // },
            ...
            links: [
              {
                // text: 'Retry lesson',
                // href: `/v6-demo/topic/lesson/${lessonId}/select-learning-content`,
                html: `<a class="small-link" href="/v6-demo/topic/lesson/${lessonId}/select-learning-content" onClick="return clearDataAndFollowLink();">Retry lesson</a><br/>`
              },
              {
                // text: 'Retry quiz',
                // href: `/v6-demo/topic/lesson/${lessonId}/start-quiz`,
                html: `<a class="small-link" href="/v6-demo/topic/lesson/${lessonId}/start-quiz" onClick="return clearDataAndFollowLink();">Retry quiz</a><br/>`
              }
            ]
          }
        ],
    ...
    router.get('/v6-demo/topic/lesson/:lessonId/text/1', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6-demo/topic/select-lesson')
      ...
      res.render('main/v6-demo/topic/lesson/text/1', {
        back: {
          text: 'Back',
          href: `/v6-demo/topic/lesson/${lessonId}/select-learning-content`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v6-demo/topic/lesson/${lessonId}/text/practice/1`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v6-demo/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get('/v6-demo/topic/lesson/:lessonId/text/2', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6-demo/topic/select-lesson')
      ...
      res.render('main/v6-demo/topic/lesson/text/2', {
        back: {
          text: 'Back',
          href: `/v6-demo/topic/lesson/${lessonId}/text/practice/1`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v6-demo/topic/lesson/${lessonId}/text/practice/2`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v6-demo/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
    ...
    router.get('/v6-demo/topic/lesson/:lessonId/text/3', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6-demo/topic/select-lesson')
      ...
      res.render('main/v6-demo/topic/lesson/text/3', {
        back: {
          text: 'Back',
          href: `/v6-demo/topic/lesson/${lessonId}/text/practice/2`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v6-demo/topic/lesson/${lessonId}/text/practice/3`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v6-demo/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
