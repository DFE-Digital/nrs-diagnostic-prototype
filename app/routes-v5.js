module.exports = {
  generateRoutesv5: function generateRoutesv5(router) {
    ...
    const lessonList = [
      {
        ...
        url: '/v5/topic/lesson/lesson-objective',
        videos: [
          {
            id: '1',
            description:
            ...
            backLink: '/v5/topic/lesson/1/select-learning-content',
            nextLink: '/v5/topic/lesson/1/video/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v5/topic/lesson/1/video/practice/1',
            nextLink: '/v5/topic/lesson/1/video/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v5/topic/lesson/1/video/practice/2',
            nextLink: '/v5/topic/lesson/1/video/practice/3'
          }
        ],
        slideshows: [
          {
            ...
            backLink: '/v5/topic/lesson/1/select-learning-content',
            nextLink: '/v5/topic/lesson/1/slideshow/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v5/topic/lesson/1/slideshow/practice/1',
            nextLink: '/v5/topic/lesson/1/slideshow/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v5/topic/lesson/1/slideshow/practice/2',
            nextLink: '/v5/topic/lesson/1/slideshow/practice/3'
          }
        ],
        practiceVideoQuestions: [
          {
            ...
            backLink: '/v5/topic/lesson/1/video/1',
            nextLink: '/v5/topic/lesson/1/video/2',
          ...
          },
          {
            ...
            backLink: '/v5/topic/lesson/1/video/2',
            nextLink: '/v5/topic/lesson/1/video/3',
            nextLinkText: 'Continue with lesson'
          },
          {
            id: '3',
            ...
            backLink: '/v5/topic/lesson/1/video/3',
            nextLink: '/v5/topic/lesson/1/start-quiz',
            nextLinkText: 'Continue with lesson'
          }
        ],
        practiceSlideshowQuestions: [
          {
            ...
            backLink: '/v5/topic/lesson/1/slideshow/1',
            nextLink: '/v5/topic/lesson/1/slideshow/2',
            nextLinkText: 'Continue with lesson'
          },
          {
            id: '2',
            ...
            backLink: '/v5/topic/lesson/1/slideshow/2',
            nextLink: '/v5/topic/lesson/1/slideshow/3',
            nextLinkText: 'Continue with lesson'
          },
          {
            id: '3',
            ...
            backLink: '/v5/topic/lesson/1/slideshow/3',
            nextLink: '/v5/topic/lesson/1/start-quiz',
            nextLinkText: 'Continue with lesson'
          }
        ],
        practiceTextQuestions: [
          {
            ...
            backLink: '/v5/topic/lesson/1/text/1',
            nextLink: '/v5/topic/lesson/1/text/2',
            nextLinkText: 'Continue with lesson'
          },
          {
            id: '2',
            ...
            backLink: '/v5/topic/lesson/1/text/2',
            nextLink: '/v5/topic/lesson/1/text/3',
            nextLinkText: 'Continue with lesson'
          },
          {
            id: '3',
            ...
            backLink: '/v5/topic/lesson/1/text/3',
            nextLink: '/v5/topic/lesson/1/start-quiz',
            nextLinkText: 'Continue with lesson'
          }
        ],
        assessmentQuestions: [
          {
            ...
            backLink: '#',
            nextLink: '/v5/topic/lesson/1/assessment/2',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v5/topic/lesson/1/assessment/3',
            nextLinkText: 'Continue with quiz'
          },
          {
            id: '3',
            ...
            backLink: '#',
            nextLink: '/v5/topic/lesson/1/assessment/4',
            nextLinkText: 'Continue with quiz'
          },
          {
            id: '4',
            ...
            backLink: '#',
            nextLink: '/v5/topic/lesson/1/assessment/5',
            nextLinkText: 'Continue with quiz'
          },
          {
            id: '5',
          ...
          links: [
            {
              ...
              href: '/v5/topic/lesson/1/start-quiz'
            }
          ]
        }
      ]
    ...
    router.get('/v5', function(req, res) {
      res.render('main/v5/start', {
        heading: {
          main: 'This is a prototype'
        },
        nextLink: '/v5/prototype-context'
      })
    })

    router.get('/v5/prototype-context', function(req, res) {
      res.render('main/v5/prototype-context', {
        heading: {
          main: 'This is a prototype'
        },
        nextLink: '/v5/context'
    ...
    router.get('/v5/end', function(req, res) {
      res.render('main/v5/end', {
        heading: {
    ...
    router.get('/v5/context', function(req, res) {
      res.render('main/v5/context-page', {
        heading: {
          main: 'English Functional Skills Level 2 course'
        },
        nextLink: '/v5/topic/select-lesson'
      })
    })

    router.get('/v5/start-part-two', function(req, res) {
      res.render('main/v5/start-part-two', {
        heading: {
          main: "You've completed the course"
        },
        description: 'You did 60 lessons over a few months.',
        nextLink: '/v5/course/completed'
      })
    })

    router.get('/v5/prototype-limit/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v5/prototype-limit', {
        heading: {
    ...
    router.get('/v5/speak-to-tutor/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v5/speak-to-tutor', {
        heading: {
    ...
    router.get('/v5/course/completed', function(req, res) {
      res.render('main/v5/course/completed', {
        heading: {
          sub: COURSE_NAME,
          main: 'Congratulations, you have completed the course!'
        },
        deadLink: '/v5/prototype-limit/' + encodeURIComponent(req.path)
      })
    })

    router.get('/v5/course/actions', function(req, res) {
      res.render('main/v5/course/actions', {
        back: {
          text: 'Return to course',
          href: `/v5/course/completed`
        },
        heading: {
    ...
    router.get('/v5/course/find-a-centre', function(req, res) {
      res.render('main/v5/course/find-a-centre', {
        back: {
          text: 'Back',
          href: `/v5/course/actions`
        },
        heading: {
        ...
        description:
          'You have completed a course. Now you can look for a test centre to sit an exam. Alternatively, if you don’t feel quite ready, you can continue learning by going back through the course or by downloading a practice paper.',
        lessonUrl: '/v5/topic/lesson/1/lesson-objective',
        side: [
          {
            title: 'Need help?',
            description:
    ...
    router.get('/v5/course/search-results', function(req, res) {
      res.render('main/v5/course/search-results', {
        back: {
          text: 'Back',
          href: `main/v5/course/find-a-centre`
        },
        heading: {
          main: 'Search results'
        },
    ...
    router.get('/v5/topic/select-lesson', function(req, res) {
      res.render('main/v5/topic/select-lesson', {
        heading: COURSE_NAME,
    ...
    router.get('/v5/topic/lesson/:lessonId/lesson-objective', function(
      req,
      res
    ) {
      ...
      if (!lesson) {
        res.redirect('/v5/topic/select-lesson')
      }
      res.render('main/v5/topic/lesson/lesson-objective', {
        back: {
          text: 'Back',
          href: '/v5/topic/select-lesson'
        },
        lesson
      })
    })

    router.get('/v5/topic/lesson/:lessonId/select-learning-content', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v5/topic/lesson/select-learning-content', {
        back: {
          text: 'Back',
          href: `/v5/topic/lesson/${lessonId}/lesson-objective`
        },
        lesson,
    ...
    router.get('/v5/topic/lesson/:lessonId/video/:videoId', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v5/topic/select-lesson')
      ...
      if (!video) {
        res.redirect(`/v5/topic/lesson/${lessonId}/select-learning-content`)
      }

      res.render('main/v5/templates/video', {
        back: {
          text: 'Back',
          href: video.backLink
        },
        ...
        actions: {
          ...
          links: [
            ...
            },
            {
              ...
              html: `<span class="govuk-body-m"><a class="small-link" href="/v5/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, article or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get('/v5/topic/lesson/:lessonId/slideshow/:slideshowId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v5/templates/slides', {
        back: {
          text: 'Back',
          href: slideshow.backLink
            ? slideshow.backLink
            : '/v5/prototype-limit/' + encodeURIComponent(req.path)
        },
        heading: lesson.title,
        slideshow,
        ...
        actions: {
          ...
          links: [
            ...
            },
            {
              ...
              // href: `/v5/topic/lesson/${lessonId}/select-learning-content`
              html: `<span class="govuk-body-m"><a class="small-link" href="/v5/topic/lesson/${lessonId}/select-learning-content">Change to video, article or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get(
      '/v5/topic/lesson/:lessonId/:media/practice/:questionId',
      function(req, res) {
        ...
        const template =
          question.type === 'input'
            ? 'main/v5/templates/question-input'
            : 'main/v5/templates/question'
    ...
    router.get('/v5/topic/lesson/:lessonId/learning-content', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      if (learningContent === 'slideshow') {
        ...
        res.redirect(`/v5/topic/lesson/${lessonId}/slideshow/${slideshow.id}`)
      } else if (learningContent === 'text') {
        res.redirect(`/v5/topic/lesson/${lessonId}/text/1`)
      } else if (learningContent === 'video') {
        const video = lesson.videos[0]
        if (!video) {
          res.redirect(`/v5/topic/lesson/${lessonId}/select-learning-content`)
        }
        res.redirect(`/v5/topic/lesson/${lessonId}/video/${video.id}`)
      } else {
        res.redirect(`/v5/topic/lesson/${lessonId}/select-learning-content`)
      }
    })

    router.get('/v5/topic/lesson/:lessonId/start-quiz', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v5/topic/select-lesson')
      }
      res.render('main/v5/topic/lesson/start-quiz', {
        back: {
          text: 'Back to lesson',
          href: `/v5/topic/lesson/${lessonId}/select-learning-content`
        },
    ...
    router.get('/v5/topic/lesson/:lessonId/assessment/:questionId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      //   ...q,
      //   backLink: '/v5/prototype-limit/' + encodeURIComponent(req.path)
      // }))
      ...
      res.render(template, {
        // back: {
        //   text: 'Back to lesson',
        //   href: '/v5/prototype-limit/' + encodeURIComponent(req.path) // videoContent.backLink
        // },
        heading: {
          sub: lesson.title,
        ...
        side: [
          {
            ...
            links: [
              ...
              {
                text: 'Speak to a tutor (via email)',
                href: '/v5/speak-to-tutor/' + encodeURIComponent(req.path)
              }
              // {
              //   text: 'Skip this question',
              //   onClick: 'return v4SkipQuestion();',
    ...
    router.get('/v5/topic/lesson/:lessonId/feedback', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v5/topic/select-lesson')
      ...
      res.render('main/v5/topic/lesson/feedback', {
        // back: {
        //   text: 'Exit lesson',
        //   href: '/v5/prototype-limit/' + encodeURIComponent(req.path)
        // },
    ...
    router.get('/v5/topic/lesson/:lessonId/text/1', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v5/topic/select-lesson')
      ...
      res.render('main/v5/topic/lesson/text/1', {
        back: {
          text: 'Back',
          href: `/v5/topic/lesson/${lessonId}/select-learning-content`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v5/topic/lesson/${lessonId}/text/practice/1`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v5/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get('/v5/topic/lesson/:lessonId/text/2', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v5/topic/select-lesson')
      ...
      res.render('main/v5/topic/lesson/text/2', {
        back: {
          text: 'Back',
          href: `/v5/topic/lesson/${lessonId}/text/practice/1`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v5/topic/lesson/${lessonId}/text/practice/2`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v5/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
    ...
    router.get('/v5/topic/lesson/:lessonId/text/3', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v5/topic/select-lesson')
      ...
      res.render('main/v5/topic/lesson/text/3', {
        back: {
          text: 'Back',
          href: `/v5/topic/lesson/${lessonId}/text/practice/2`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v5/topic/lesson/${lessonId}/text/practice/3`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v5/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
