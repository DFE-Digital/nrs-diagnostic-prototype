module.exports = {
  generateRoutesV8_hj: function generateRoutesV8_hj(router) {
    ...
    const lessonList = [
      {
        ...
        url: '/v8-hj/topic/lesson/lesson-objective',
        videos: [
          {
            id: '1',
            description:
            ...
            backLink: '/v8-hj/topic/lesson/1/select-learning-content',
            nextLink: '/v8-hj/topic/lesson/1/video/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v8-hj/topic/lesson/1/video/practice/1',
            nextLink: '/v8-hj/topic/lesson/1/video/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v8-hj/topic/lesson/1/video/practice/2',
            nextLink: '/v8-hj/topic/lesson/1/video/practice/3'
          }
        ],
        slideshows: [
          {
            ...
            backLink: '/v8-hj/topic/lesson/1/select-learning-content',
            nextLink: '/v8-hj/topic/lesson/1/slideshow/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v8-hj/topic/lesson/1/slideshow/practice/1',
            nextLink: '/v8-hj/topic/lesson/1/slideshow/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v8-hj/topic/lesson/1/slideshow/practice/2',
            nextLink: '/v8-hj/topic/lesson/1/slideshow/practice/3'
          }
        ],
        practiceVideoQuestions: [
          {
            ...
            backLink: '/v8-hj/topic/lesson/1/video/1',
            nextLink: '/v8-hj/topic/lesson/1/video/2',
          ...
          },
          {
            ...
            backLink: '/v8-hj/topic/lesson/1/video/2',
            nextLink: '/v8-hj/topic/lesson/1/video/3',
          ...
          },
          {
            ...
            backLink: '/v8-hj/topic/lesson/1/video/3',
            nextLink: '/v8-hj/topic/lesson/1/start-quiz',
        ...
        practiceSlideshowQuestions: [
          {
            ...
            backLink: '/v8-hj/topic/lesson/1/slideshow/1',
            nextLink: '/v8-hj/topic/lesson/1/slideshow/2',
            nextLinkText: 'Continue to part 2'
          },
          {
            id: '2',
            ...
            backLink: '/v8-hj/topic/lesson/1/slideshow/2',
            nextLink: '/v8-hj/topic/lesson/1/slideshow/3',
            nextLinkText: 'Continue to part 3'
          },
          {
            id: '3',
            ...
            backLink: '/v8-hj/topic/lesson/1/slideshow/3',
            nextLink: '/v8-hj/topic/lesson/1/start-quiz',
            nextLinkText: 'Continue to quiz'
          }
        ],
        practiceTextQuestions: [
          {
            ...
            backLink: '/v8-hj/topic/lesson/1/text/1',
            nextLink: '/v8-hj/topic/lesson/1/text/2',
            nextLinkText: 'Continue to part 2'
          },
          {
            id: '2',
            ...
            backLink: '/v8-hj/topic/lesson/1/text/2',
            nextLink: '/v8-hj/topic/lesson/1/text/3',
            nextLinkText: 'Continue to part 3'
          },
          {
            id: '3',
            ...
            backLink: '/v8-hj/topic/lesson/1/text/3',
            nextLink: '/v8-hj/topic/lesson/1/start-quiz',
            nextLinkText: 'Continue to quiz'
          }
        ],
        assessmentQuestions: [
          {
            ...
            backLink: '#',
            nextLink: '/v8-hj/topic/lesson/1/assessment/2',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v8-hj/topic/lesson/1/assessment/3',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v8-hj/topic/lesson/1/assessment/4',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v8-hj/topic/lesson/1/assessment/5',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v8-hj/topic/lesson/1/feedback',
          ...
          links: [
            {
              ...
              href: '/v8-hj/prototype-limit/' + encodeURIComponent(path)
            },
            {
              text: 'Speak to a tutor (via email)',
              href: '/v8-hj/speak-to-tutor/' + encodeURIComponent(path)
            },
            {
              text: 'Technical support',
              href: '/v8-hj/technical-support/' + encodeURIComponent(path)
            }
          ]
        },
        {
          ...
          links: [
            {
              ...
              href: '/v8-hj/topic/lesson/1/start-quiz'
            }
          ]
        }
      ]
    ...
    router.get('/v8-hj', function(req, res) {
      res.render('main/v8-hj/start', {
        ...
        nextLink: '/v8-hj/prototype-context'
      })
    })

    router.get('/v8-hj/prototype-context', function(req, res) {
      res.render('main/v8-hj/prototype-context', {
        heading: {
          main: 'This is a prototype'
        },
    ...
    router.get('/v8-hj/step-by-step', function(req, res) {
      res.render('main/v8-hj/step-by-step', {
        heading: {
          main:
        ...
        nextLink: '/v8-hj/context'
      })
    })

    router.get('/v8-hj/step-by-step-end', function(req, res) {
      res.render('main/v8-hj/step-by-step-end', {
        heading: {
          main:
            'Get a qualification in functional skills English level 2: step by step'
        },
    ...
    router.get('/v8-hj/context', function(req, res) {
      res.render('main/v8-hj/context-page', {
        heading: {
          main: 'Functional Skills English Level 2'
        },
        nextLink: '/v8-hj/topic/select-lesson'
      })
    })

    router.get('/v8-hj/start-part-two', function(req, res) {
      res.render('main/v8-hj/start-part-two', {
        heading: {
    ...
    router.get('/v8-hj/prototype-limit/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v8-hj/prototype-limit', {
        heading: {
    ...
    router.get('/v8-hj/speak-to-tutor/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v8-hj/speak-to-tutor', {
        heading: {
    ...
    router.get('/v8-hj/technical-support/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v8-hj/technical-support', {
        heading: {
          main:
    ...
    router.get('/v8-hj/diagnostic', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v8-hj/vignette/diagnostic', {
        heading: {
    ...
    router.get('/v8-hj/course/completed', function(req, res) {
      res.render('main/v8-hj/course/completed', {
        heading: {
          sub: COURSE_NAME,
          main: 'Congratulations, you have completed the course!'
        },
        deadLink: '/v8-hj/prototype-limit/' + encodeURIComponent(req.path)
      })
    })

    router.get('/v8-hj/course/actions', function(req, res) {
      res.render('main/v8-hj/course/actions', {
        back: {
        ...
        side: [
          {
            ...
            links: [
              ...
              },
              {
                ...
                href: '/v8-hj/prototype-limit/' + encodeURIComponent(req.path)
              },
              {
                html:
    ...
    router.get('/v8-hj/course/find-a-centre', function(req, res) {
      res.render('main/v8-hj/course/find-a-centre', {
        ...
        // description:
        //   'You have completed a course. Now you can look for a test centre to sit an exam. Alternatively, if you don’t feel quite ready, you can continue learning by going back through the course or by downloading a practice paper.',
        lessonUrl: '/v8-hj/topic/lesson/1/lesson-objective',
        side: [
          {
            title: 'Need help?',
            description:
    ...
    router.get('/v8-hj/course/search-results', function(req, res) {
    ...
    router.get('/v8-hj/topic/select-lesson', function(req, res) {
      res.render('main/v8-hj/topic/select-lesson', {
        heading: COURSE_NAME,
    ...
    router.get('/v8-hj/topic/lesson/:lessonId/lesson-objective', function(
      req,
      res
    ) {
      ...
      if (!lesson) {
        res.redirect('/v8-hj/topic/select-lesson')
      }
      res.render('main/v8-hj/topic/lesson/lesson-objective', {
        back: {
          text: 'Back',
          href: '/v8-hj/topic/select-lesson'
        },
        lesson
      })
    })
    ...
    router.get(
      '/v8-hj/topic/lesson/:lessonId/select-learning-content',
      function(req, res) {
        const lessonId = req.params.lessonId
        const lesson = lessonList.find(x => x.id === lessonId)
        if (!lesson) {
        ...
        res.render('main/v8-hj/topic/lesson/select-learning-content', {
          back: {
            text: 'Back',
            href: `/v8-hj/topic/lesson/${lessonId}/lesson-objective`
          },
          lesson,
    ...
    router.get('/v8-hj/topic/lesson/:lessonId/video/:videoId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      if (!video) {
        res.redirect(`/v8-hj/topic/lesson/${lessonId}/select-learning-content`)
      }

      res.render('main/v8-hj/templates/video', {
        back: {
          text: 'Back',
          href: video.backLink
        },
        ...
        actions: {
          ...
          links: [
            ...
            },
            {
              ...
              // href: `/v8-hj/topic/lesson/${lessonId}/select-learning-content`
              html: `<span class="govuk-body-m"><a class="small-link" href="/v8-hj/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, article or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get('/v8-hj/topic/lesson/:lessonId/slideshow/:slideshowId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v8-hj/templates/slides', {
        back: {
          text: 'Back',
          href: slideshow.backLink
            ? slideshow.backLink
            : '/v8-hj/prototype-limit/' + encodeURIComponent(req.path)
        },
        heading: lesson.title,
        slideshow,
        ...
        actions: {
          ...
          links: [
            ...
            },
            {
              ...
              // href: `/v8-hj/topic/lesson/${lessonId}/select-learning-content`
              html: `<span class="govuk-body-m"><a class="small-link" href="/v8-hj/topic/lesson/${lessonId}/select-learning-content">Change to video, article or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get(
      '/v8-hj/topic/lesson/:lessonId/:media/practice/:questionId',
      function(req, res) {
        ...
        const template =
          question.type === 'input'
            ? 'main/v8-hj/templates/question-input'
            : 'main/v8-hj/templates/question'
    ...
    router.get('/v8-hj/topic/lesson/:lessonId/learning-content', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      if (learningContent === 'slideshow') {
        ...
        res.redirect(
          `/v8-hj/topic/lesson/${lessonId}/slideshow/${slideshow.id}`
        )
      } else if (learningContent === 'text') {
        res.redirect(`/v8-hj/topic/lesson/${lessonId}/text/1`)
        ...
        res.redirect(`/v8-hj/topic/lesson/${lessonId}/video/${video.id}`)
      } else {
        res.redirect(`/v8-hj/topic/lesson/${lessonId}/select-learning-content`)
      }
    })

    router.get('/v8-hj/topic/lesson/:lessonId/start-quiz', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v8-hj/topic/select-lesson')
      }
      res.render('main/v8-hj/topic/lesson/start-quiz', {
        back: {
          text: 'Back to lesson',
          href: `/v8-hj/topic/lesson/${lessonId}/select-learning-content`
        },
        ...
        side: [
          {
            ...
            links: [
              ...
              {
                text: 'Speak to a tutor (via email)',
                href: '/v8-hj/speak-to-tutor/' + encodeURIComponent(req.path)
              }
            ]
          }
        ]
    ...
    router.get('/v8-hj/topic/lesson/:lessonId/assessment/:questionId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      //   ...q,
      //   backLink: '/v8-hj/prototype-limit/' + encodeURIComponent(req.path)
      // }))
      ...
      res.render(template, {
        // back: {
        //   text: 'Back to lesson',
        //   href: '/v8-hj/prototype-limit/' + encodeURIComponent(req.path) // videoContent.backLink
        // },
        heading: {
          sub: lesson.title,
    ...
    router.get('/v8-hj/topic/lesson/:lessonId/feedback', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v8-hj/topic/select-lesson')
      ...
      res.render('main/v8-hj/topic/lesson/feedback', {
        // back: {
        //   text: 'Exit lesson',
        //   href: '/v8-hj/prototype-limit/' + encodeURIComponent(req.path)
        // },
            ...
            links: [
              {
                // text: 'Retry lesson',
                // href: `/v8-hj/topic/lesson/${lessonId}/select-learning-content`,
                html: `<a class="small-link" href="/v8-hj/topic/lesson/${lessonId}/select-learning-content" onClick="return clearDataAndFollowLink();">Retry lesson</a><br/>`
              },
              {
                // text: 'Retry quiz',
                // href: `/v8-hj/topic/lesson/${lessonId}/start-quiz`,
                html: `<a class="small-link" href="/v8-hj/topic/lesson/${lessonId}/start-quiz" onClick="return clearDataAndFollowLink();">Retry quiz</a><br/>`
              }
            ]
          }
        ],
    ...
    router.get('/v8-hj/topic/lesson/:lessonId/text/1', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v8-hj/topic/select-lesson')
      ...
      res.render('main/v8-hj/topic/lesson/text/1', {
        back: {
          text: 'Back',
          href: `/v8-hj/topic/lesson/${lessonId}/select-learning-content`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v8-hj/topic/lesson/${lessonId}/text/practice/1`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v8-hj/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get('/v8-hj/topic/lesson/:lessonId/text/2', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v8-hj/topic/select-lesson')
      ...
      res.render('main/v8-hj/topic/lesson/text/2', {
        back: {
          text: 'Back',
          href: `/v8-hj/topic/lesson/${lessonId}/text/practice/1`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v8-hj/topic/lesson/${lessonId}/text/practice/2`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v8-hj/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
    ...
    router.get('/v8-hj/topic/lesson/:lessonId/text/3', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v8-hj/topic/select-lesson')
      ...
      res.render('main/v8-hj/topic/lesson/text/3', {
        back: {
          text: 'Back',
          href: `/v8-hj/topic/lesson/${lessonId}/text/practice/2`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v8-hj/topic/lesson/${lessonId}/text/practice/3`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v8-hj/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
    ...
    router.get('/v8-hj/static/step-by-step', function(req, res) {
      res.render('main/v8-hj/static/step-by-step', {
        heading: {
          main:
            'Get a qualification in functional skills English level 2: step by step'
        },
    ...
    router.get('/v8-hj/static/feedback', function(req, res) {
      const lessonId = '1'
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v8-hj/topic/select-lesson')
      ...
      res.render('main/v8-hj/static/feedback', {
        // back: {
        //   text: 'Exit lesson',
        //   href: '/v8-hj/prototype-limit/' + encodeURIComponent(req.path)
        // },
    ...
    router.get('/v8-hj/static/find-a-centre', function(req, res) {
      res.render('main/v8-hj/static/find-a-centre', {
        back: {
          text: 'Back',
          href: `#`
        },
    ...
    router.get('/v8-hj/static/search-results', function(req, res) {
      res.render('main/v8-hj/static/search-results', {
        back: {
          text: 'Back',
          href: `#`
        },
    ...
    router.get('/v8-hj/static/completed', function(req, res) {
      res.render('main/v8-hj/static/completed', {
        heading: {
          sub: COURSE_NAME,
          main: 'Congratulations, you have completed the course!'
        },
