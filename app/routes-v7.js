module.exports = {
  generateRoutesV7: function generateRoutesV7(router) {
    ...
    const lessonList = [
      {
        ...
        url: '/v7/topic/lesson/lesson-objective',
        videos: [
          {
            id: '1',
            description:
            ...
            backLink: '/v7/topic/lesson/1/select-learning-content',
            nextLink: '/v7/topic/lesson/1/video/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v7/topic/lesson/1/video/practice/1',
            nextLink: '/v7/topic/lesson/1/video/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v7/topic/lesson/1/video/practice/2',
            nextLink: '/v7/topic/lesson/1/video/practice/3'
          }
        ],
        slideshows: [
          {
            ...
            backLink: '/v7/topic/lesson/1/select-learning-content',
            nextLink: '/v7/topic/lesson/1/slideshow/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v7/topic/lesson/1/slideshow/practice/1',
            nextLink: '/v7/topic/lesson/1/slideshow/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v7/topic/lesson/1/slideshow/practice/2',
            nextLink: '/v7/topic/lesson/1/slideshow/practice/3'
          }
        ],
        practiceVideoQuestions: [
          {
            ...
            backLink: '/v7/topic/lesson/1/video/1',
            nextLink: '/v7/topic/lesson/1/video/2',
          ...
          },
          {
            ...
            backLink: '/v7/topic/lesson/1/video/2',
            nextLink: '/v7/topic/lesson/1/video/3',
          ...
          },
          {
            ...
            backLink: '/v7/topic/lesson/1/video/3',
            nextLink: '/v7/topic/lesson/1/start-quiz',
        ...
        practiceSlideshowQuestions: [
          {
            ...
            backLink: '/v7/topic/lesson/1/slideshow/1',
            nextLink: '/v7/topic/lesson/1/slideshow/2',
            nextLinkText: 'Continue to part 2'
          },
          {
            id: '2',
            ...
            backLink: '/v7/topic/lesson/1/slideshow/2',
            nextLink: '/v7/topic/lesson/1/slideshow/3',
            nextLinkText: 'Continue to part 3'
          },
          {
            id: '3',
            ...
            backLink: '/v7/topic/lesson/1/slideshow/3',
            nextLink: '/v7/topic/lesson/1/start-quiz',
            nextLinkText: 'Continue to quiz'
          }
        ],
        practiceTextQuestions: [
          {
            ...
            backLink: '/v7/topic/lesson/1/text/1',
            nextLink: '/v7/topic/lesson/1/text/2',
            nextLinkText: 'Continue to part 2'
          },
          {
            id: '2',
            ...
            backLink: '/v7/topic/lesson/1/text/2',
            nextLink: '/v7/topic/lesson/1/text/3',
            nextLinkText: 'Continue to part 3'
          },
          {
            id: '3',
            ...
            backLink: '/v7/topic/lesson/1/text/3',
            nextLink: '/v7/topic/lesson/1/start-quiz',
            nextLinkText: 'Continue to quiz'
          }
        ],
        assessmentQuestions: [
          {
            ...
            backLink: '#',
            nextLink: '/v7/topic/lesson/1/assessment/2',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v7/topic/lesson/1/assessment/3',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v7/topic/lesson/1/assessment/4',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v7/topic/lesson/1/assessment/5',
          ...
          },
          {
            ...
            backLink: '#',
            nextLink: '/v7/topic/lesson/1/feedback',
          ...
          links: [
            {
              ...
              href: '/v7/prototype-limit/' + encodeURIComponent(path)
            },
            {
              text: 'Speak to a tutor (via email)',
              href: '/v7/speak-to-tutor/' + encodeURIComponent(path)
            },
            {
              text: 'Technical support',
              href: '/v7/technical-support/' + encodeURIComponent(path)
            }
          ]
        },
        {
          ...
          links: [
            {
              ...
              href: '/v7/topic/lesson/1/start-quiz'
            }
          ]
        }
      ]
    ...
    router.get('/v7', function(req, res) {
      res.render('main/v7/start', {
        heading: {
          main: 'This is a prototype'
        },
        nextLink: '/v7/prototype-context'
      })
    })

    router.get('/v7/prototype-context', function(req, res) {
      res.render('main/v7/prototype-context', {
        heading: {
          main: 'This is a prototype'
        },
    ...
    router.get('/v7/start-part-two', function(req, res) {
      res.render('main/v7/start-part-two', {
        heading: {
          main: "You've completed the course"
        },
        description: 'You did 60 lessons over a few months.',
        nextLink: '/v7/course/completed'
      })
    })

    router.get('/v7/prototype-limit/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v7/prototype-limit', {
        heading: {
    ...
    router.get('/v7/speak-to-tutor/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v7/speak-to-tutor', {
        heading: {
    ...
    router.get('/v7/technical-support/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v7/technical-support', {
        heading: {
          main:
    ...
    router.get('/v7/course/completed', function(req, res) {
      res.render('main/v7/course/completed', {
        heading: {
          sub: COURSE_NAME,
          main: 'Congratulations, you have completed the course!'
        },
        deadLink: '/v7/prototype-limit/' + encodeURIComponent(req.path)
      })
    })

    router.get('/v7/course/actions', function(req, res) {
      res.render('main/v7/course/actions', {
        back: {
          text: 'Return to course',
          href: `/v7/course/completed`
        },
        heading: {
    ...
    router.get('/v7/course/find-a-centre', function(req, res) {
      res.render('main/v7/course/find-a-centre', {
        back: {
          text: 'Back',
          href: `/v7/course/actions`
        },
        heading: {
        ...
        // description:
        //   'You have completed a course. Now you can look for a test centre to sit an exam. Alternatively, if you don’t feel quite ready, you can continue learning by going back through the course or by downloading a practice paper.',
        lessonUrl: '/v7/topic/lesson/1/lesson-objective',
        side: [
          {
            title: 'Need help?',
            description:
    ...
    router.get('/v7/course/search-results', function(req, res) {
      res.render('main/v7/course/search-results', {
        back: {
          text: 'Back',
          href: `main/v7/course/find-a-centre`
        },
        heading: {
          main: 'Search results'
        },
    ...
    router.get('/v7/topic/select-lesson', function(req, res) {
      res.render('main/v7/topic/select-lesson', {
        heading: COURSE_NAME,
    ...
    router.get('/v7/topic/lesson/:lessonId/lesson-objective', function(
      req,
      res
    ) {
      ...
      res.render('main/v7/topic/lesson/lesson-objective', {
        back: {
          text: 'Back',
          href: '/v7/topic/select-lesson'
        },
        lesson
      })
    })

    router.get('/v7/topic/lesson/:lessonId/select-learning-content', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v7/topic/lesson/select-learning-content', {
        back: {
          text: 'Back',
          href: `/v7/topic/lesson/${lessonId}/lesson-objective`
        },
        lesson,
    ...
    router.get('/v7/topic/lesson/:lessonId/video/:videoId', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v7/topic/select-lesson')
      ...
      if (!video) {
        res.redirect(`/v7/topic/lesson/${lessonId}/select-learning-content`)
      }

      res.render('main/v7/templates/video', {
        back: {
          text: 'Back',
          href: video.backLink
        },
        ...
        actions: {
          ...
          links: [
            ...
            },
            {
              ...
              html: `<span class="govuk-body-m"><a class="small-link" href="/v7/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, article or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get('/v7/topic/lesson/:lessonId/slideshow/:slideshowId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v7/templates/slides', {
        back: {
          text: 'Back',
          href: slideshow.backLink
            ? slideshow.backLink
            : '/v7/prototype-limit/' + encodeURIComponent(req.path)
        },
        heading: lesson.title,
        slideshow,
        ...
        actions: {
          ...
          links: [
            ...
            },
            {
              ...
              // href: `/v7/topic/lesson/${lessonId}/select-learning-content`
              html: `<span class="govuk-body-m"><a class="small-link" href="/v7/topic/lesson/${lessonId}/select-learning-content">Change to video, article or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get(
      '/v7/topic/lesson/:lessonId/:media/practice/:questionId',
      function(req, res) {
        ...
        const template =
          question.type === 'input'
            ? 'main/v7/templates/question-input'
            : 'main/v7/templates/question'
    ...
    router.get('/v7/topic/lesson/:lessonId/learning-content', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      if (learningContent === 'slideshow') {
        ...
        res.redirect(`/v7/topic/lesson/${lessonId}/slideshow/${slideshow.id}`)
      } else if (learningContent === 'text') {
        res.redirect(`/v7/topic/lesson/${lessonId}/text/1`)
      } else if (learningContent === 'video') {
        const video = lesson.videos[0]
        if (!video) {
          res.redirect(`/v7/topic/lesson/${lessonId}/select-learning-content`)
        }
        res.redirect(`/v7/topic/lesson/${lessonId}/video/${video.id}`)
      } else {
        res.redirect(`/v7/topic/lesson/${lessonId}/select-learning-content`)
      }
    })

    router.get('/v7/topic/lesson/:lessonId/start-quiz', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v7/topic/select-lesson')
      }
      res.render('main/v7/topic/lesson/start-quiz', {
        back: {
          text: 'Back to lesson',
          href: `/v7/topic/lesson/${lessonId}/select-learning-content`
        },
        ...
        side: [
          {
            ...
            links: [
              ...
              {
                text: 'Speak to a tutor (via email)',
                href: '/v7/speak-to-tutor/' + encodeURIComponent(req.path)
              }
            ]
          }
        ]
    ...
    router.get('/v7/topic/lesson/:lessonId/assessment/:questionId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      //   ...q,
      //   backLink: '/v7/prototype-limit/' + encodeURIComponent(req.path)
      // }))
      ...
      res.render(template, {
        // back: {
        //   text: 'Back to lesson',
        //   href: '/v7/prototype-limit/' + encodeURIComponent(req.path) // videoContent.backLink
        // },
        heading: {
          sub: lesson.title,
    ...
    router.get('/v7/topic/lesson/:lessonId/feedback', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v7/topic/select-lesson')
      ...
      res.render('main/v7/topic/lesson/feedback', {
        // back: {
        //   text: 'Exit lesson',
        //   href: '/v7/prototype-limit/' + encodeURIComponent(req.path)
        // },
    ...
    router.get('/v7/topic/lesson/:lessonId/text/1', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v7/topic/select-lesson')
      ...
      res.render('main/v7/topic/lesson/text/1', {
        back: {
          text: 'Back',
          href: `/v7/topic/lesson/${lessonId}/select-learning-content`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v7/topic/lesson/${lessonId}/text/practice/1`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v7/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get('/v7/topic/lesson/:lessonId/text/2', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v7/topic/select-lesson')
      ...
      res.render('main/v7/topic/lesson/text/2', {
        back: {
          text: 'Back',
          href: `/v7/topic/lesson/${lessonId}/text/practice/1`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v7/topic/lesson/${lessonId}/text/practice/2`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v7/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
    ...
    router.get('/v7/topic/lesson/:lessonId/text/3', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v7/topic/select-lesson')
      ...
      res.render('main/v7/topic/lesson/text/3', {
        back: {
          text: 'Back',
          href: `/v7/topic/lesson/${lessonId}/text/practice/2`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v7/topic/lesson/${lessonId}/text/practice/3`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v7/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
