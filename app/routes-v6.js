module.exports = {
  generateRoutesV6: function generateRoutesV6(router) {
    ...
    const lessonList = [
      {
        ...
        url: '/v6/topic/lesson/lesson-objective',
        videos: [
          {
            id: '1',
            description:
            ...
            backLink: '/v6/topic/lesson/1/select-learning-content',
            nextLink: '/v6/topic/lesson/1/video/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v6/topic/lesson/1/video/practice/1',
            nextLink: '/v6/topic/lesson/1/video/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v6/topic/lesson/1/video/practice/2',
            nextLink: '/v6/topic/lesson/1/video/practice/3'
          }
        ],
        slideshows: [
          {
            ...
            backLink: '/v6/topic/lesson/1/select-learning-content',
            nextLink: '/v6/topic/lesson/1/slideshow/practice/1'
          },
          {
            id: '2',
            description:
            ...
            backLink: '/v6/topic/lesson/1/slideshow/practice/1',
            nextLink: '/v6/topic/lesson/1/slideshow/practice/2'
          },
          {
            id: '3',
            description:
            ...
            backLink: '/v6/topic/lesson/1/slideshow/practice/2',
            nextLink: '/v6/topic/lesson/1/slideshow/practice/3'
          }
        ],
          ...
          links: [
            {
              ...
              href: '/v6/topic/lesson/1/start-quiz'
            }
          ]
        }
      ]
    ...
    router.get('/v6', function(req, res) {
      res.render('main/v6/start', {
        heading: {
          main: 'This is a prototype'
        },
        nextLink: '/v6/prototype-context'
      })
    })

    router.get('/v6/prototype-context', function(req, res) {
      res.render('main/v6/prototype-context', {
        heading: {
          main: 'This is a prototype'
        },
        nextLink: '/v6/context'
    ...
    router.get('/v6/end', function(req, res) {
      res.render('main/v6/end', {
        heading: {
    ...
    router.get('/v6/start-part-two', function(req, res) {
      res.render('main/v6/start-part-two', {
        heading: {
          main: "You've completed the course"
        },
        description: 'You did 60 lessons over a few months.',
        nextLink: '/v6/course/completed'
      })
    })

    router.get('/v6/prototype-limit/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v6/prototype-limit', {
        heading: {
    ...
    router.get('/v6/speak-to-tutor/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
    ...
    router.get('/v6/course/completed', function(req, res) {
    ...
    router.get('/v6/course/actions', function(req, res) {
      res.render('main/v6/course/actions', {
        back: {
          text: 'Return to course',
          href: `/v6/course/completed`
        },
        heading: {
    ...
    router.get('/v6/course/find-a-centre', function(req, res) {
      res.render('main/v6/course/find-a-centre', {
        back: {
          text: 'Back',
          href: `/v6/course/actions`
        },
        heading: {
    ...
    router.get('/v6/course/search-results', function(req, res) {
      res.render('main/v6/course/search-results', {
        back: {
          text: 'Back',
          href: `main/v6/course/find-a-centre`
        },
        heading: {
          main: 'Search results'
        },
    ...
    router.get('/v6/topic/select-lesson', function(req, res) {
      res.render('main/v6/topic/select-lesson', {
        heading: COURSE_NAME,
    ...
    router.get('/v6/topic/lesson/:lessonId/lesson-objective', function(
      req,
      res
    ) {
      ...
      if (!lesson) {
        res.redirect('/v6/topic/select-lesson')
      }
      res.render('main/v6/topic/lesson/lesson-objective', {
        back: {
          text: 'Back',
          href: '/v6/topic/select-lesson'
        },
        lesson
      })
    })

    router.get('/v6/topic/lesson/:lessonId/select-learning-content', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v6/topic/lesson/select-learning-content', {
        back: {
          text: 'Back',
          href: `/v6/topic/lesson/${lessonId}/lesson-objective`
        },
        lesson,
    ...
    router.get('/v6/topic/lesson/:lessonId/video/:videoId', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6/topic/select-lesson')
      ...
      if (!video) {
        res.redirect(`/v6/topic/lesson/${lessonId}/select-learning-content`)
      }

      res.render('main/v6/templates/video', {
        back: {
          text: 'Back',
          href: video.backLink
        },
        ...
        actions: {
          ...
          links: [
            ...
            },
            {
              ...
              html: `<span class="govuk-body-m"><a class="small-link" href="/v6/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, article or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get('/v6/topic/lesson/:lessonId/slideshow/:slideshowId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v6/templates/slides', {
        back: {
          text: 'Back',
          href: slideshow.backLink
            ? slideshow.backLink
            : '/v6/prototype-limit/' + encodeURIComponent(req.path)
        },
        heading: lesson.title,
        slideshow,
        ...
        actions: {
          ...
          links: [
            ...
            },
            {
              ...
              // href: `/v6/topic/lesson/${lessonId}/select-learning-content`
              html: `<span class="govuk-body-m"><a class="small-link" href="/v6/topic/lesson/${lessonId}/select-learning-content">Change to video, article or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get(
      '/v6/topic/lesson/:lessonId/:media/practice/:questionId',
      function(req, res) {
        ...
        const template =
          question.type === 'input'
            ? 'main/v6/templates/question-input'
            : 'main/v6/templates/question'
    ...
    router.get('/v6/topic/lesson/:lessonId/learning-content', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      if (learningContent === 'slideshow') {
        ...
        res.redirect(`/v6/topic/lesson/${lessonId}/slideshow/${slideshow.id}`)
      } else if (learningContent === 'text') {
        res.redirect(`/v6/topic/lesson/${lessonId}/text/1`)
      } else if (learningContent === 'video') {
        const video = lesson.videos[0]
        if (!video) {
          res.redirect(`/v6/topic/lesson/${lessonId}/select-learning-content`)
        }
        res.redirect(`/v6/topic/lesson/${lessonId}/video/${video.id}`)
      } else {
        res.redirect(`/v6/topic/lesson/${lessonId}/select-learning-content`)
      }
    })

    router.get('/v6/topic/lesson/:lessonId/start-quiz', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6/topic/select-lesson')
      }
      res.render('main/v6/topic/lesson/start-quiz', {
        back: {
          text: 'Back to lesson',
          href: `/v6/topic/lesson/${lessonId}/select-learning-content`
        },
    ...
    router.get('/v6/topic/lesson/:lessonId/assessment/:questionId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      //   ...q,
      //   backLink: '/v6/prototype-limit/' + encodeURIComponent(req.path)
      // }))
      ...
      res.render(template, {
        // back: {
        //   text: 'Back to lesson',
        //   href: '/v6/prototype-limit/' + encodeURIComponent(req.path) // videoContent.backLink
        // },
        heading: {
          sub: lesson.title,
    ...
    router.get('/v6/topic/lesson/:lessonId/feedback', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6/topic/select-lesson')
      ...
      res.render('main/v6/topic/lesson/feedback', {
        // back: {
        //   text: 'Exit lesson',
        //   href: '/v6/prototype-limit/' + encodeURIComponent(req.path)
        // },
    ...
    router.get('/v6/topic/lesson/:lessonId/text/1', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6/topic/select-lesson')
      ...
      res.render('main/v6/topic/lesson/text/1', {
        back: {
          text: 'Back',
          href: `/v6/topic/lesson/${lessonId}/select-learning-content`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v6/topic/lesson/${lessonId}/text/practice/1`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v6/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
            }
          ]
        },
        side: helpLinks(req.path)
    ...
    router.get('/v6/topic/lesson/:lessonId/text/2', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6/topic/select-lesson')
      ...
      res.render('main/v6/topic/lesson/text/2', {
        back: {
          text: 'Back',
          href: `/v6/topic/lesson/${lessonId}/text/practice/1`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v6/topic/lesson/${lessonId}/text/practice/2`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v6/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
    ...
    router.get('/v6/topic/lesson/:lessonId/text/3', function(req, res) {
      const lessonId = req.params.lessonId
      const lesson = lessonList.find(x => x.id === lessonId)
      if (!lesson) {
        res.redirect('/v6/topic/select-lesson')
      ...
      res.render('main/v6/topic/lesson/text/3', {
        back: {
          text: 'Back',
          href: `/v6/topic/lesson/${lessonId}/text/practice/2`
        },
        ...
        actions: {
          ...
          links: [
            {
              text: 'Continue with lesson',
              href: `/v6/topic/lesson/${lessonId}/text/practice/3`,
              isButton: true
            },
            {
              html: `<span class="govuk-body-m"><a class="small-link" href="/v6/topic/lesson/${lessonId}/select-learning-content">Change to slideshow, video or audio</a></p>`
