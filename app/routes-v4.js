module.exports = {
  generateRoutesV4: function generateRoutesV4(router) {
    ...
    router.get('/v4/topic/lesson/:lessonId/lesson-objective', function(
      req,
      res
    ) {
    ...
    router.get(
      '/v4/topic/lesson/:lessonId/:media/practice/:questionId',
      function(req, res) {
    ...
    router.get('/v4/topic/lesson/:lessonId/learning-content', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
