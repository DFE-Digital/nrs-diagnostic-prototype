module.exports = {
  generateRoutesv4_2: function generateRoutesv4_2(router) {
    ...
    router.get('/v4-2/prototype-limit/:returnUrl', function(req, res) {
      const returnUrl = req.params.returnUrl
      res.render('main/v4-2/prototype-limit', {
        heading: {
    ...
    router.get('/v4-2/topic/lesson/:lessonId/video/:videoId', function(
      req,
      res
    ) {
      const lessonId = req.params.lessonId
      ...
      res.render('main/v4-2/templates/slides', {
        back: {
          ...
          href: slideshow.backLink
            ? slideshow.backLink
            : '/v4-2/prototype-limit/' + encodeURIComponent(req.path)
        },
        heading: lesson.title,
        slideshow,
    ...
    router.get('/v4-2/topic/lesson/:lessonId/assessment/:questionId', function(
      ...
      //   ...q,
      //   backLink: '/v4-2/prototype-limit/' + encodeURIComponent(req.path)
      // }))
